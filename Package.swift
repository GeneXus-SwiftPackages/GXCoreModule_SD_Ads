...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.21.xcframework.zip",
			checksum: "99108b2677adcd5978eb9bc878878ea1dd56261d1e50e789b16fb4a574acfc16"
		)
	]
)