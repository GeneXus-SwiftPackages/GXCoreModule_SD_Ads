...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.11.xcframework.zip",
			checksum: "e36672884b27a43ed88034e72e21817ccd46bba440b45f5bd0fa5d6c81cff3c7"
		)
	]
)