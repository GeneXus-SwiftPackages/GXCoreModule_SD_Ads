...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.0.xcframework.zip",
			checksum: "c5766d9422faebe047a8cf8b879ad491fdc740927228ccd4b51dcdadca35073a"
		)
	]
)