...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "3ef8a53eaf6046c912fad52409e8c531c3a21fbf860782b0e89472a6b5e9419a"
		)
	]
)