...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.31.xcframework.zip",
			checksum: "5c57ea9d829e192f20175f3b65a75515e332f8ff9d71a67c1aa0715abe0578a0"
		)
	]
)