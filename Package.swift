...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.6.0-beta.1.xcframework.zip",
			checksum: "460838c581f6d407902490398142437138f6b93fd81e0d6806ed87fa01819d69"
		)
	]
)