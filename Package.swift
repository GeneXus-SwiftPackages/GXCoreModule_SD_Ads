...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.10.xcframework.zip",
			checksum: "06c7e44a3a2cea4b6126f87791ceb39afe355e65395ae5394a40eec96472f0e9"
		)
	]
)