...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.12.xcframework.zip",
			checksum: "3e1755b142e1e02e3d8cff252e95cb040b9fe48615baa28101e35bc124753a03"
		)
	]
)