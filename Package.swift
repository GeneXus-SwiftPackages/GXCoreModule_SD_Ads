...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.11.xcframework.zip",
			checksum: "a7679fff503dd19b221c37841b3946740cee2c4091d7264d05bf899934da0adc"
		)
	]
)