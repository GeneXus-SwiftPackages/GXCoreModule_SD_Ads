...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.36.xcframework.zip",
			checksum: "72ab5b7b0b901fdb5e91d013fb38847ba64eb44c9c8ce9e5a309522e0b49c99c"
		)
	]
)