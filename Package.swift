...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.1.0-beta.26.xcframework.zip",
			checksum: "efbf7e3c295847a36815a81319f4ef7498f63bccbe4d1bbab02c772ea95a80e3"
		)
	]
)