...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.37.xcframework.zip",
			checksum: "9b9cc9abd21bc1096621db7cf80dd2808bebca304c68badabdeab373d2d3fdb7"
		)
	]
)