...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.18.xcframework.zip",
			checksum: "16373956dd186ac7b7c74ef805b50817fd8d24fa785620081b41053c7ed51600"
		)
	]
)