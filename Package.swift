...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "fdaa2c3231ef74e53b65ac0526712df99810c86830d1c0af271f337e69ef5bc9"
		)
	]
)