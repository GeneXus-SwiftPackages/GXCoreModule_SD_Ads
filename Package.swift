...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.24.xcframework.zip",
			checksum: "f303bbdf91258e2cf69e4cd566dc9055cb929c26bcaec48a9e00ca417a00c919"
		)
	]
)