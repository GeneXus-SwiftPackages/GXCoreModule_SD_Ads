...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.3.6.xcframework.zip",
			checksum: "1cedfffd25e08200a55224296404f0e8033a4d598b171444f2ac4b3e1083d897"
		)
	]
)