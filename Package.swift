...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-2.0.0-rc.32.xcframework.zip",
			checksum: "273b54f12dff6663ee9090ac12d94c9be0961dffb425becebb2e429962bb4306"
		)
	]
)