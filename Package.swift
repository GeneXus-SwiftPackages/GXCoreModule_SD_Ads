...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.1.0-rc.22.xcframework.zip",
			checksum: "76e269f8009c8bfdcc1b92c2eed64bc2180a038bc223e25d0cfd6499c33b4509"
		)
	]
)