...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.37.xcframework.zip",
			checksum: "a9e6ed672e2518d6248e8a28f225efa401935b490e6d876c910895702ae14f0e"
		)
	]
)