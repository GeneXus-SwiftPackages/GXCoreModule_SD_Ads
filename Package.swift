...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.794.xcframework.zip",
			checksum: "17e237a249a471b282ffb062b066ba19ee9e021ef6ac07bc59f88bcf547248e5"
		)
	]
)