...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.7.xcframework.zip",
			checksum: "072f01e9e82f8d1accf9ca89ebace7548f682a65c281b4bcc1790c0bf510c80a"
		)
	]
)