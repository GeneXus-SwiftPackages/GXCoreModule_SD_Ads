...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230627202653.xcframework.zip",
			checksum: "b9102c25be6ca5d011d4c52f600256ea825962f2e3ae264dde29ee839700c512"
		)
	]
)