...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.5.11.xcframework.zip",
			checksum: "730b47c018420585564b04747adbf8432e758b79a1404e23e0c611ae4c8db54d"
		)
	]
)