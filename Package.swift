...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.6.0-beta.0.xcframework.zip",
			checksum: "8a8d2b4710a7216c35a3350a2dad73c8296cc12b5df5b3a9dcf360c6ff7a6b33"
		)
	]
)