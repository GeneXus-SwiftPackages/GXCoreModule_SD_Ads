...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.47.xcframework.zip",
			checksum: "a617ea2ff47bf12df9eac677031b8bf63ec489b54a86b83d6d3e6b1df764f2d1"
		)
	]
)