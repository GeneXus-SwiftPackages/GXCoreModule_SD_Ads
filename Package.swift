...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.33.xcframework.zip",
			checksum: "b93ddfb3dafc41376796e93a80c718577b011a2a38c487c070edeb70dab3584f"
		)
	]
)