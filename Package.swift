...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230620165651.xcframework.zip",
			checksum: "99dde1152a02f1c00f6c27f85205d4c8bbee7632e37a3412d95836fbc3414dc0"
		)
	]
)