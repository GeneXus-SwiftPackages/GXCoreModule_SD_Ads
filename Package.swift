...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.48.xcframework.zip",
			checksum: "5f4301f27c0430bb54c8700c645d1d6c22b0498d01608a5dd8383ab59b2326d7"
		)
	]
)