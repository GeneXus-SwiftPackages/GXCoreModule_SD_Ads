...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.26.xcframework.zip",
			checksum: "b3c8bef05bdcdf69658d11143f104c02c8b84e29e451d261e32085267745226d"
		)
	]
)