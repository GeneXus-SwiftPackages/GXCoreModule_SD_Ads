...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.1.0-rc.1.xcframework.zip",
			checksum: "53bcbf5c4a4bc9a69fcc9a9b636a118153df49767243198a5dcaa1d8212cea9a"
		)
	]
)