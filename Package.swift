...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.15.xcframework.zip",
			checksum: "4562d298ace5ffd9ee5c68cb0c1ed6ec729c2daffe547de31e695430a0d7959d"
		)
	]
)