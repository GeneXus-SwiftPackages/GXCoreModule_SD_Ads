...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.5.xcframework.zip",
			checksum: "f052ab2670079cf1e5102423f5be5a9a5a186269597822397c14beb0b3a646b8"
		)
	]
)