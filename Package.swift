...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.6.xcframework.zip",
			checksum: "befbf8045d9ba71751429f620343aeccdc59d5ae70178da96e445c818d2ba561"
		)
	]
)