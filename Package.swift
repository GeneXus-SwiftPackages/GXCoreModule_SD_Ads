...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.24.xcframework.zip",
			checksum: "11a756136da47cecda69cb450d146e9e28edaf1a8ddc5f4ee9db2bc7179eaa95"
		)
	]
)