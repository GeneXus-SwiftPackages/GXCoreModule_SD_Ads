...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.33.xcframework.zip",
			checksum: "8e01dabdf49a03d889bbd4f9fabbe6b52b2e73494259405711287e3e2b601e80"
		)
	]
)