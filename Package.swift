...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.4.xcframework.zip",
			checksum: "e0326c35d9a2db699516c35f0fb4c37cc4940d396336ff483c8194d5233887c7"
		)
	]
)