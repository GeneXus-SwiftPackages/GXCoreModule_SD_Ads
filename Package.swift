...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "37eddc05ec1da08e1eefe3a15cbb81b3d7923c3b1de8df8e71745e5dd9ec5949"
		)
	]
)