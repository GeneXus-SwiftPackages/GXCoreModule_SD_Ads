...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.1.3.xcframework.zip",
			checksum: "57cb2e0a46f0c1a6bcb2f7cd7d43db0fc11ba26ba76dc55e4fa6fb6fe635e519"
		)
	]
)