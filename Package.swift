...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.19.xcframework.zip",
			checksum: "03a290818f6d6b6ba2fde08708ac85c3442e4ca700b4ef2b2ee20a2c2ecf6e74"
		)
	]
)