...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.15.xcframework.zip",
			checksum: "188b58deb7262264dbd1410e2240d459eecce360da9a5fd81a9e9c484b0fdad2"
		)
	]
)