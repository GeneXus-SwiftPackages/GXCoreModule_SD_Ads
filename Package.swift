...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.1.1.xcframework.zip",
			checksum: "d92ea64b7ec1518a3e3167aea0ee56b60f86ca88140993c18701c906f712d534"
		)
	]
)