...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.24.xcframework.zip",
			checksum: "7e76afbd9ba8773e0289322c752651005f2e90ed16d8b629e62e6954b8e13740"
		)
	]
)