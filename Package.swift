...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.10.xcframework.zip",
			checksum: "b5f1e3a6fc2bcca0e9672af0120abfece7e2a3d9b0d964d4be2442ae1293200f"
		)
	]
)