...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.0.2.xcframework.zip",
			checksum: "6ffc051478cd9bc8f283a4c3c2002453930919c036f3a31d9f7f7451dde61e31"
		)
	]
)