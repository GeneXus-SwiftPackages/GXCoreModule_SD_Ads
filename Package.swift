...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.5.0-rc.26.xcframework.zip",
			checksum: "5f60b956ea5fe12c0993c32df7045109f563bcd1315fc9f6a45aa8db82aa2fa1"
		)
	]
)