...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.9.xcframework.zip",
			checksum: "46096f482c6c22bc704b4673ade118c5586e78f49fd9375af585d3216df0bee4"
		)
	]
)