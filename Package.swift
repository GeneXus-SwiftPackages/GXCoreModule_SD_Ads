...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.1.2.xcframework.zip",
			checksum: "badc24bf8aede972c53d32b1adf73669886a186006732223f42205be31e9ffcf"
		)
	]
)