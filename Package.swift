...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.20.xcframework.zip",
			checksum: "1690c51c22ae0b4f2a67979cdda46ab0b2d774e5a29b66df9d27c5831f36343c"
		)
	]
)