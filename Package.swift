...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.27.xcframework.zip",
			checksum: "10213de0eab845d35db403807b5386c229cbdff0da6bfff059f4d78259e5b751"
		)
	]
)