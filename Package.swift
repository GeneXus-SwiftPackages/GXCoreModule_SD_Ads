...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230630183632.xcframework.zip",
			checksum: "d693b10f07be81bae47195c02402a6a572764dd8f653579b9a7dd44af6195fa6"
		)
	]
)