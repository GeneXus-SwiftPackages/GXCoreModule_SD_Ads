...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.25.xcframework.zip",
			checksum: "251904e1b95169443e14bf721a47c4405d8ca57082cd217a1261a99ce846be92"
		)
	]
)