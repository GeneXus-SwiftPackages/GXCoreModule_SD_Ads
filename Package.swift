...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.5.xcframework.zip",
			checksum: "0d8d1a48e9bb1082cab06fd8fc3f65b471f4c56199d77a1c8be68e436edead54"
		)
	]
)