...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.13.xcframework.zip",
			checksum: "8d6264bc0ed6cebf6fae5d0f478bda7cb63b82ee80b82c18a90a7540c1da7272"
		)
	]
)