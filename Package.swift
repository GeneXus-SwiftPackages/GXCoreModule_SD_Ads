...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.4.0-rc.10.xcframework.zip",
			checksum: "f693c47bb9032cf0f7985e7f428e192a4db3da86f18fc5324b8acc5e1234381f"
		)
	]
)