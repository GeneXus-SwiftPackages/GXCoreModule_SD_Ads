...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.1.0-beta.23.xcframework.zip",
			checksum: "2d208492ce9eff799b2d09f67c15fef1ac21a5c899efb65e8544561c2d3d1ab6"
		)
	]
)