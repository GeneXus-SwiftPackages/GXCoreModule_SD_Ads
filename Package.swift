...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.6.xcframework.zip",
			checksum: "a79b5e6a909f554eb5a27e78f8e8bcaf284e4c4b948e98db0151e51ac23d65db"
		)
	]
)