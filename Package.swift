...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.25.xcframework.zip",
			checksum: "7d6d646dc19cf6926d7bd2d46ffb8b6f1c37676baaeac1b63548847471d40988"
		)
	]
)