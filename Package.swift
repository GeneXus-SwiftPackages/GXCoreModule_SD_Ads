...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.2.0-rc.0.xcframework.zip",
			checksum: "8fc6ceb0827d1d4fbefab79064540ef14b208a555f105104f8d3d12fcc2d6359"
		)
	]
)