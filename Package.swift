...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.38.xcframework.zip",
			checksum: "2240792eb932ced20fe88b1b2f7fcd6b309c3ef4e00eb4115e9b42a76f725aba"
		)
	]
)