...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.19.xcframework.zip",
			checksum: "b09e7dc27fd51fa45c90863207e386f81a344b7bbdff1c5f2e502fc757a689c2"
		)
	]
)