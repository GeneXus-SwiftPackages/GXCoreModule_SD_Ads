...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-3.1.0-rc.8.xcframework.zip",
			checksum: "8d843562e0c8d1fe70b869ea9cbd85bb67b3e548b4116a6bf1a030ab78165437"
		)
	]
)