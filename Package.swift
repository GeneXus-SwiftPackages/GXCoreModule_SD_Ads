...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.44.xcframework.zip",
			checksum: "ac4b807a64613a81a9d121a1e5774f0999d6e693b278fa537675e9e7fb53e549"
		)
	]
)