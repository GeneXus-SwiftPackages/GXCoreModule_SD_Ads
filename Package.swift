...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.32.xcframework.zip",
			checksum: "021f3d9e266be5873c6432f62fbb96d4754c81f94df75a35a8762f7d7596534e"
		)
	]
)