...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.19.xcframework.zip",
			checksum: "54194f42d2374833fc3cae40804cbb6c0542ccb9da66e63fcda07741e855cf6f"
		)
	]
)