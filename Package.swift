...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.15.xcframework.zip",
			checksum: "98b21eb7b75ef0206733ac8ac2b2870d922fb8bec6255f94fe1e7c4010b26f59"
		)
	]
)