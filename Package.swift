...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.22.xcframework.zip",
			checksum: "1de682486e555724b44d73fa574543f7091deadcb5148dd5468e3b7dcd2b9f52"
		)
	]
)