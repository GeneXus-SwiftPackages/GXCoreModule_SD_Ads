...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.9.xcframework.zip",
			checksum: "3875bc0b7ea41a727ed684c246363970eda9d70ba50731d661039b7e630e7341"
		)
	]
)