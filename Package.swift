...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.6.xcframework.zip",
			checksum: "9f0c0a7c7d04b716c9f7ba99345c83a52aaa43e38a6b536078e5f0f454025a51"
		)
	]
)