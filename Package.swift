...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.9.xcframework.zip",
			checksum: "08979215afdd47621989ce56975f74438394431f15b5e0ae1460bdff8eca5815"
		)
	]
)