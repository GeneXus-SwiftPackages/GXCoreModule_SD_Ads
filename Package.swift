...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.20.xcframework.zip",
			checksum: "7a0d665fe703d42a218d25e0a28b248f44ef727174e24880fe12ed4a6a9353e6"
		)
	]
)