...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.12.xcframework.zip",
			checksum: "dec0002b01c038f2886d04e216f3d3f3efe510a3bb730e3c66278dcb068dfc17"
		)
	]
)