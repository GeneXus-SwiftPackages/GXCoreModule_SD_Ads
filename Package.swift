...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.3.0-rc.1.xcframework.zip",
			checksum: "e21e3ff11211b9c260f2c0052bcce00d49c177f44b08a201e4e48cc15784d586"
		)
	]
)