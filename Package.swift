...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.10.xcframework.zip",
			checksum: "e9d0fab4dfcab597f0d21c31a4a093816b9e4280f92969dfa53ad48e5bee9f40"
		)
	]
)