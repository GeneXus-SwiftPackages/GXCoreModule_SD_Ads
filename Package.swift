...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.31.xcframework.zip",
			checksum: "cd54f89769b225d00c2d5c6b73cfbcb26392a4cfbafa5f632947f494b2af1f76"
		)
	]
)