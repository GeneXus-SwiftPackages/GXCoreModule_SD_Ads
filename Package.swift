...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.19.xcframework.zip",
			checksum: "2454cb96079caed1283ec74110bec1ad6d2be00d1c5676d45599900c6883ca98"
		)
	]
)