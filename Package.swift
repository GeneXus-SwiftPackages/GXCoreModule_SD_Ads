...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.5.xcframework.zip",
			checksum: "5c69b8c43275783207a26660d6af0e5701f208aff20ed65509deafc617b9064e"
		)
	]
)