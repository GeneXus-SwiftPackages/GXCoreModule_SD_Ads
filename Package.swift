...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.11.xcframework.zip",
			checksum: "71b853d0595638cef1191cda4e8a7577e154fb2edf00667194a467c70f2ef059"
		)
	]
)