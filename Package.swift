...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-3.2.0-rc.12.xcframework.zip",
			checksum: "86f292175eb00318a2138d074893fe7149a167a4386ad3923dac3c7c5be163bf"
		)
	]
)