...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.6.xcframework.zip",
			checksum: "689ea48b6b833b6ada6cca9b8b5e4157c64d967aef6044fc6217fc31ab2f9c27"
		)
	]
)