...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.11.xcframework.zip",
			checksum: "995ea7f9e8dbc334c032bd5d62cf98a7bffdfbd1c86deb6d1cb2f8000c4247d2"
		)
	]
)