...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.14.xcframework.zip",
			checksum: "8f595251cdefeb08c37e6c8497f1f12bb64fdd3817d59dfb9256eb745125fb64"
		)
	]
)