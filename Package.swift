...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.14.xcframework.zip",
			checksum: "3e5ff6d008be72180fb3e0a4bd100cf1a78781bc4268f169d573364983a719be"
		)
	]
)