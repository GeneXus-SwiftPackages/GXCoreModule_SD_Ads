...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.2.xcframework.zip",
			checksum: "ce2b40808e2e5a594df6f4ce3d4dd3526de54bd5977a2751b1be1136591fa655"
		)
	]
)