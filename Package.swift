...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-2.1.0.xcframework.zip",
			checksum: "50c650ca5d8afda02267466574b114600bf6647997a67bbf8d5d6e4c24fe7842"
		)
	]
)