...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.4.xcframework.zip",
			checksum: "c96099ee2e154e24cc1763e8803ddd2013fdab0dc546276176384b8001497dd9"
		)
	]
)