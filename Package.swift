...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "155df47efb480b17c0107cbdd7eb054b1474edd322f18deeb65b1f78c6547c1f"
		)
	]
)