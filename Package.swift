...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.2.xcframework.zip",
			checksum: "5023e6fe5946b5ab4c1bd4d07528152d5db3a613ec03813bde8aaeb8d544b693"
		)
	]
)