...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.25.xcframework.zip",
			checksum: "04274dcd66a1a4273ebebde0aa5ee124e484b537e8bfb213cea98202ecb2b95d"
		)
	]
)