...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.17.xcframework.zip",
			checksum: "c6a363529e737185b9e960c9fbae3210c98eed33676b5f5c2e95db353835faf2"
		)
	]
)