...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.2.0-rc.37.xcframework.zip",
			checksum: "0fd5603e0073a847a71c28d799d570e95844f73f371b637c2e9c50b169f2f4a4"
		)
	]
)