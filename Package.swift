...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.5.xcframework.zip",
			checksum: "f982599b6dbdfc61f846d1dbc28f49f5955c793f6a6cdb95bd527f0ee4b6a817"
		)
	]
)