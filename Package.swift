...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.37.xcframework.zip",
			checksum: "95e2c3c098ee73fed4184c433e4ccd3924c2515bca33bb1baf675f51a7d2cc34"
		)
	]
)