...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.1.0-beta.25.xcframework.zip",
			checksum: "5decdc4b11d0f003bff7f482565f745c21c38793b0b9f2e90b41c31d1d9a55df"
		)
	]
)