...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-2.1.3.xcframework.zip",
			checksum: "3283c15ee4d73536c9c88243a672c69e248e41ac964e8742f70b4b084978a857"
		)
	]
)