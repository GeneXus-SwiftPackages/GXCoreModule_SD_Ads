...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.39.xcframework.zip",
			checksum: "15f0f2034b77de8834cf492f558f33fc1b64efe50bcb8903f91c809de4b3dacb"
		)
	]
)