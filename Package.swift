...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.32.xcframework.zip",
			checksum: "fe29c5737127bb2e9f3c1d44d37443627daf65e979e234981f84f9f31662f9ad"
		)
	]
)