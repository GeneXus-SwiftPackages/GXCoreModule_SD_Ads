...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.28.xcframework.zip",
			checksum: "45c50e68f9a98109fd50771fa4760bd06efa6ac60d3fa68ac98f68b9a12cfea9"
		)
	]
)