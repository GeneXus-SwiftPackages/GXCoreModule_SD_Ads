...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.17.xcframework.zip",
			checksum: "39d5474a854acd3f8584780091206f26e0db72c24863a3a7d2f96bee205d5d4b"
		)
	]
)