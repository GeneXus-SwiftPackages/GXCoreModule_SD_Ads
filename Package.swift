...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.7.xcframework.zip",
			checksum: "b76f42779d8bdc3d95f5b2d3f1ee95928a2fe6ab3649ef836e9023aa6292ff36"
		)
	]
)