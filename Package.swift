...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.25.xcframework.zip",
			checksum: "75a9128d5bac708ec7f6a2048c4d30cb1e0e062504ccbf4371ce70f64fcf676c"
		)
	]
)