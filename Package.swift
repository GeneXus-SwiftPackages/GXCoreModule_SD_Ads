...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.23.xcframework.zip",
			checksum: "5c6a8f88eaef29f132006fffd31a55e45c88df64e6eec497ef1746a6852721ad"
		)
	]
)