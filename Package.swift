...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.10.xcframework.zip",
			checksum: "82524ecce42b13723ed377fe56c432eba53dd6534ea9d25f5336b6c8e87bd25a"
		)
	]
)