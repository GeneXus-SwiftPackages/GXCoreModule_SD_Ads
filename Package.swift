...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.8.xcframework.zip",
			checksum: "cf91649dfaee41780a7be87ccd6e7dd4a35760cdbb3f50e9fa6b77dd9c7054ea"
		)
	]
)