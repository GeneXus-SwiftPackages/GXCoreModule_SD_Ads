...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.13.xcframework.zip",
			checksum: "f820ce982226c8c2b11fdab8fc40d78a5b8dd626cff7b01fab27a79d96a4b77a"
		)
	]
)