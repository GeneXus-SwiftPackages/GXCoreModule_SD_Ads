...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.7.xcframework.zip",
			checksum: "3b42af87dc19c8b56a9d45e84a523646e53e536419be7d2202cedab1bb48aa3d"
		)
	]
)