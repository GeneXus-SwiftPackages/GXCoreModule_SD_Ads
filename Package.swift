...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.22.xcframework.zip",
			checksum: "1e1603bf2d4c68d417d0e510862e2fc9844c51960915f4ce148814d16ddddc9a"
		)
	]
)