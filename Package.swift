...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.8.xcframework.zip",
			checksum: "6e5eb0f4430a6e1d312976c7876a41f2cd9f628c70741de700ac7b790ac1aab2"
		)
	]
)