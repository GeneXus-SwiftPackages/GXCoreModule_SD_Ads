...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.7.xcframework.zip",
			checksum: "3392be7b23cb4a5897ae6ff9e9ceb12c6a34c6937815a36e1edb4ff8c6ae57fb"
		)
	]
)