...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.24.xcframework.zip",
			checksum: "10dffd8e6cd8715465b5278bd53c350584c01f5dcc153f42313e4eaa9baba1c2"
		)
	]
)