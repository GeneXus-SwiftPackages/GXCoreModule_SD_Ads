...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.26.xcframework.zip",
			checksum: "63f607de8dac40179a3762e5db37476597ba596b9bbba4606425e991a2cfaf0b"
		)
	]
)