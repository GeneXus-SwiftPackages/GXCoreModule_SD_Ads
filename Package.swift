...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230614190626.xcframework.zip",
			checksum: "ea01a2b303ee25a9201c891e4d8cbf72b4612eb63623be18c0ac153a0228202e"
		)
	]
)