...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.20.xcframework.zip",
			checksum: "6c4a79a4c86205f1ccca70a34a85b5d8541118f3f0690fbcecc46b2a55350f38"
		)
	]
)