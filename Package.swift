...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230714111921.xcframework.zip",
			checksum: "816332d04567cced59f764bb443026461750b66317e1544ce60acf92fbcb1da0"
		)
	]
)