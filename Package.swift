...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.0.0-rc.0.xcframework.zip",
			checksum: "3a030e6eb9fe1f45a13b2d25d024737f6a7196c0deccc0e3698724e04a50ee01"
		)
	]
)