...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.26.xcframework.zip",
			checksum: "bc7e29c925e8feed7b63ef4933e9a594fa2ef99fc9603717687fd82cefe32913"
		)
	]
)