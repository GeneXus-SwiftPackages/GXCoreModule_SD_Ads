...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.27.xcframework.zip",
			checksum: "ce0ccd7519ebb5bddcf6129251d0445ceed77ee2a95d586da81d692c1dfea7a1"
		)
	]
)