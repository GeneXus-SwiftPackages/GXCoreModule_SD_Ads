...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.0.xcframework.zip",
			checksum: "caac3e4ecdfc480c46a8b02a40b394b8eb2a16e95e535fe037435588130576b8"
		)
	]
)