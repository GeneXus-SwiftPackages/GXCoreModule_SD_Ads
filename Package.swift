...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.7.xcframework.zip",
			checksum: "ea34d21cac81c877c52cae973897429b9c4c108c15fcd17406c60fd8e2d1e5a5"
		)
	]
)