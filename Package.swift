...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.2.0.xcframework.zip",
			checksum: "6675f462ac8c01c77180feed1d8c480884779ab50c296be4ec0d7c1239e39c44"
		)
	]
)