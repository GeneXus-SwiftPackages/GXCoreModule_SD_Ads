...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.27.xcframework.zip",
			checksum: "578b6705f18d9d1d649cfe16b9c78f16ab40d5f10fcddb1f1dcf826375dc5149"
		)
	]
)