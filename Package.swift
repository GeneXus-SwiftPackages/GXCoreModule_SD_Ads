...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.3.xcframework.zip",
			checksum: "e7d5589522ab08164779e7c228d3a66f74310f0bdae408fd9618affbf43297d0"
		)
	]
)