...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.18.xcframework.zip",
			checksum: "66194e69d85ccc20d7ef7be21415c5f7a1d7dae9584172e366eadab348f0d793"
		)
	]
)