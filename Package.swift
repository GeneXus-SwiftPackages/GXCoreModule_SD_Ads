...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.13.xcframework.zip",
			checksum: "3b0fc8fea3275f90983370d708327c9f075180141b19129becc640ce557df605"
		)
	]
)