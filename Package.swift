...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.20.xcframework.zip",
			checksum: "b7e33066a7b22067bdeaf5f2a15d326f30c99e9af21d597ff3487beec7e5bff9"
		)
	]
)