...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.11.xcframework.zip",
			checksum: "6acaaf75c7d66b1c7b27a2c4af9c19a79cd5921a6aa8f2756ac061641608ac68"
		)
	]
)