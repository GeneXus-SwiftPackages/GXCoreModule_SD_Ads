...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "d57ba7126d44748cf1fe95925e386cddaa914c87b653c0d1c2bc549b60a07184"
		)
	]
)