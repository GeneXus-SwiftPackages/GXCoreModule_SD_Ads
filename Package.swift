...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.1.4.xcframework.zip",
			checksum: "89ecc0e66a1ddea75a938c3a8b8c50155ad410f6857909f982d9069d0de35041"
		)
	]
)