...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.37.xcframework.zip",
			checksum: "7ff05367bb3270a38e4129d43e6449035b60b596ac336eae4b79bb7922e8afcf"
		)
	]
)