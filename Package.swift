...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.1.xcframework.zip",
			checksum: "f942a17dce8d0d6c3e6a8468b2be895fbfc7ba8d4a580de3068504d79b62a8fb"
		)
	]
)