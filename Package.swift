...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.6.xcframework.zip",
			checksum: "28a105cb21ca9b66fa3bcb2f40dcfd000fc8eeaa5ea2aa0f75d64094cd3bbeab"
		)
	]
)