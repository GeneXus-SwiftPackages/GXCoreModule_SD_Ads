...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.5.17.xcframework.zip",
			checksum: "5ddb54afa87c782ee47611d04366925f942cac5c1fb8a27d9b88f89343b966cc"
		)
	]
)