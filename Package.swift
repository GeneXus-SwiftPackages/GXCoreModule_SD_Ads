...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.28.xcframework.zip",
			checksum: "261b40ebceb6aa9055d19aa049933a1c2db2708769af08f35148ad9b05eb3de2"
		)
	]
)