...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.18.xcframework.zip",
			checksum: "db1adc934a1e051516cceb359effc1d8e5c5e87651f3e0d33495f6b5dcc08d39"
		)
	]
)