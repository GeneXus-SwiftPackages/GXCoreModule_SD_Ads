...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.2.0-rc.20.xcframework.zip",
			checksum: "4b6b8119501fdde8bbef6bbd2a5280f3e7062b1e9ba03d4546788a7f32b36bda"
		)
	]
)