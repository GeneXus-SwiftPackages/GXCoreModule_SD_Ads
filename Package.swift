...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.3.xcframework.zip",
			checksum: "c2324280d0944e94df573d47aae5cf178154219e1e5cf34f474e685528deed50"
		)
	]
)