...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.35.xcframework.zip",
			checksum: "fc40198297bc5731a37214896c07f15c4e2f6a2bec999393dd5140b3792244e2"
		)
	]
)