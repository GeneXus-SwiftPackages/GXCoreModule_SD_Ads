...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.34.xcframework.zip",
			checksum: "3f885ad6794b34c46bfa84701bfcc05a8a14bf5360839d0c63656088323da15a"
		)
	]
)