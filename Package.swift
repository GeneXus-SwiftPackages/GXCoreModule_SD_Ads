...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.5.xcframework.zip",
			checksum: "276498b48f4c1f05cf8bf882ce2c27586c3afa0ba2f277e64cc131d94973cec0"
		)
	]
)