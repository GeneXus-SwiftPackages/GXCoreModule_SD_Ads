...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.3.xcframework.zip",
			checksum: "58c9421cef98033e0ea501e9685202b60b14fe222f52e67e72426380df7985a1"
		)
	]
)