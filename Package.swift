...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.11.xcframework.zip",
			checksum: "1e49ba34f1757bba4b942cd65e54ce2401969d6133a579eef2ecee54da3995f1"
		)
	]
)