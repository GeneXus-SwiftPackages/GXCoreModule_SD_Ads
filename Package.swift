...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "e40a5c44ad72a98af512f6037ffe8df1edadeeda05bb64788b74054950fb256f"
		)
	]
)