...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.27.xcframework.zip",
			checksum: "a7653b964d7512d93f94e67b7c69660b236a1a19dad528d0ce5fc0b5460ae1b4"
		)
	]
)