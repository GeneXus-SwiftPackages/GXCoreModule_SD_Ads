...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "315ce0c4b6e9a434433aabf667745a1131cde7df2c9ddfab6dd163f6d68fa07c"
		)
	]
)