...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.12.xcframework.zip",
			checksum: "fbf4772a56f0be414c8d9f9fb9cb20d52c22e8578dc037521353194b670719b6"
		)
	]
)