...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.27.xcframework.zip",
			checksum: "ec81a257939e73f65d2070be0f4c61c9170682b4959c62a43606413cbd4a2e7b"
		)
	]
)