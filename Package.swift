...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.6.xcframework.zip",
			checksum: "a0985b5d39e3be9c30ba9b17fc67ecca5c144db200c71aecdbb1d04d2e20c754"
		)
	]
)