...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.14.xcframework.zip",
			checksum: "21357f80d855450aeb100c774bc0b227a0337c318e319f084ebfc2fd50d29d17"
		)
	]
)