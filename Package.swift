...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.2.0-rc.29.xcframework.zip",
			checksum: "336758383bfc796270847fa3987764b417735885711c6fef59e3bcf0899a5de2"
		)
	]
)