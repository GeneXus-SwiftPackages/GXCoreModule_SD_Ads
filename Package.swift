...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.4.29.xcframework.zip",
			checksum: "90c0dfddc52f96de61f4666c3949cdf9a174224aff403ecb86f775689a15cc03"
		)
	]
)