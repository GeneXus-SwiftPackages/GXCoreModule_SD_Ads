...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.5.xcframework.zip",
			checksum: "bee3181ed68290768ff591eab31754e1e4691f8207813585476f43992c2469c6"
		)
	]
)