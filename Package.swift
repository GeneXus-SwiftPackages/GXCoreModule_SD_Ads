...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.1.xcframework.zip",
			checksum: "cbeeb4c0b0fb5bc2b3e827649dc5c29fab16549fb4138672c4b6916430082917"
		)
	]
)