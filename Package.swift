...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "d907212e50b784e34fa153294fa937ea00ac1dc185a3a5d308fe27c0246c7c1d"
		)
	]
)