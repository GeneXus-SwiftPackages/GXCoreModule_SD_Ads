...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.16.xcframework.zip",
			checksum: "76cc518ebc56690a36752607d8fb91ff3d3d2d7e9adc3caed7ca8d7f9ee69cc4"
		)
	]
)