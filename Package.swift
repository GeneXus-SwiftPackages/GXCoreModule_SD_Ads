...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.795.xcframework.zip",
			checksum: "ea254a04b94c59954c967ed781e9c5182e2404f036421516754fccaf2cbeeb34"
		)
	]
)