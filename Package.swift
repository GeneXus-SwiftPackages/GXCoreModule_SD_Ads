...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.0.0-rc.43.xcframework.zip",
			checksum: "0452905af5e2d40f3766be6a98e9d999409da40e06444fd56db0bc58f9c8ac3f"
		)
	]
)