...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.25.xcframework.zip",
			checksum: "dac2a6c8e832cc39cd6ff60a1825fdb573e8476af826a50a0e8053788f7a4bd2"
		)
	]
)