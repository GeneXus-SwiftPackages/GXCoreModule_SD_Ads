...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.22.xcframework.zip",
			checksum: "4705d019265e9a003d674885908f8bde458679092adcc8a70b94c7ea70be2626"
		)
	]
)