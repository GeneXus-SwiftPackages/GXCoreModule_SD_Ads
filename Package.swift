...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.41.xcframework.zip",
			checksum: "d2a374f198819062b844d4c08861aa64e6a35b78952ba42c4efd2972e873b823"
		)
	]
)