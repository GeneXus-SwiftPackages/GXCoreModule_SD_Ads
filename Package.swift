...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.11.xcframework.zip",
			checksum: "33eb66d4d782e371c426e66c37d0c7042a71925c3dc0fc57d76344942f2e0df8"
		)
	]
)