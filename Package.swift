...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "70a4952f383cf2efd6effe61c59f957ec62e0ea94883b5ca984e160d533831f8"
		)
	]
)