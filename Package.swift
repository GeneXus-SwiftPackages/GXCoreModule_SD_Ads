...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.17.xcframework.zip",
			checksum: "61d4b9adc667cfd80a364fd571313616bf412db1d6eb89dc5db5c35fcb2cf557"
		)
	]
)