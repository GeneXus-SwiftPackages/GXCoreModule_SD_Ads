...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-3.2.0-rc.0.xcframework.zip",
			checksum: "4612c8b99b9b133b97f847611a76b1f4ab623c0bd6d55758aa248b2f92099c44"
		)
	]
)