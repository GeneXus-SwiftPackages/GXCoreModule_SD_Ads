...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.6.xcframework.zip",
			checksum: "b354889dc247e926cec6312df501ed37e6110cc0485fa062e01911faaf979420"
		)
	]
)