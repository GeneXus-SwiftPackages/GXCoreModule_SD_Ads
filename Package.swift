...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.1.1.xcframework.zip",
			checksum: "08903f174a050c280765894057eceea73e367d652bff2159cfa7a55efe2fd7cc"
		)
	]
)