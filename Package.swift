...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "deaf6f03dc5253ad467956896050e6021bbdc61979d957a9589b1ec1945e26be"
		)
	]
)