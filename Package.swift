...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.2.0-rc.25.xcframework.zip",
			checksum: "afb0ad22f0dd9d288f34817685e911c59a38ceb03ae4f39f42b775e948a58fb6"
		)
	]
)