...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.2.2.xcframework.zip",
			checksum: "e89a27f160eab78b5c9d3aee4063ed2211d5fd694b30a7dfa3df3a2f13c31314"
		)
	]
)