...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.7.xcframework.zip",
			checksum: "553bf28ff2bbceccad750424d5e708b5b633fe1b882d8c52d1ef4943ffdf7097"
		)
	]
)