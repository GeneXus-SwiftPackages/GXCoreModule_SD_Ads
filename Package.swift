...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.23.xcframework.zip",
			checksum: "dba69601cfb8d9e128c9da724c60022aafb59145a040bc6754f4d57801f42419"
		)
	]
)