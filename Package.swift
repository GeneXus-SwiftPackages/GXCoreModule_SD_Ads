...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "164fe0bb0ee89118f29c264be016560c51d976b3019fa5e8e50d471ae39a0272"
		)
	]
)