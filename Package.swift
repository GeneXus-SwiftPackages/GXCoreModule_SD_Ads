...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.13.xcframework.zip",
			checksum: "872b61c31fbc9ae166fdd6ac6a9d646ffd0a1ac3123572f597e323064a817c42"
		)
	]
)