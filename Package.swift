...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.24.xcframework.zip",
			checksum: "95c7edb22b22e3fc81e1d8a77c58fd79321788a41593a2fd349d73ecd3fd7215"
		)
	]
)