...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.4.31.xcframework.zip",
			checksum: "54cc2d805b9b46005cfbf5101f37b8bb79c4a3d299cd87cb65b22e788096f551"
		)
	]
)