...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.2.xcframework.zip",
			checksum: "046b4bf222e6e715fb08ea2101bff6fbbd1725c28c9048557b9b16ab954d0d01"
		)
	]
)