...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.32.xcframework.zip",
			checksum: "554d8b609fb21e16aa70940c48359f46eff884de6a3fec3e612268080e40459e"
		)
	]
)