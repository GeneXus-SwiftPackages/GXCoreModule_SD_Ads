...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.30.xcframework.zip",
			checksum: "5e77c3f5e8b8bd2602c827b77510bca5f71338c5a6d65e85223bb9c194486686"
		)
	]
)