...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.33.xcframework.zip",
			checksum: "7b3b7f7afb72926e35bf34f7d7acc4ecb657cb2ae0dd31cdcaa692379437a114"
		)
	]
)