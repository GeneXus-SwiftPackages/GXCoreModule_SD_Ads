...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta+20230608211628.xcframework.zip",
			checksum: "a9a9756566ab3949dc7d1bddca21e4b07afbd0b466715744aa0c71c27a5cbabc"
		)
	]
)