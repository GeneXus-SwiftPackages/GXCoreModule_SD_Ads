...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230706155940.xcframework.zip",
			checksum: "481869f6c4a7095285d4ebd874d3a5f50e9a8bc20ddf9452ae58339745bb8455"
		)
	]
)