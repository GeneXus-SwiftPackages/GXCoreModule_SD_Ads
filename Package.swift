...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.4.xcframework.zip",
			checksum: "60679cdee1a00643133a9a5d530a85af3b980beb03f7e143d4a27b6f9d83ace6"
		)
	]
)