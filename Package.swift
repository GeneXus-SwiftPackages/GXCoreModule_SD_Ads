...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.27.xcframework.zip",
			checksum: "8999417f3dbe17041f3ae1314025f0c39f239aa725369b0dbad66f93d26b208d"
		)
	]
)