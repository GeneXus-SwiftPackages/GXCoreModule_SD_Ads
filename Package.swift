...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.5.0-rc.2.xcframework.zip",
			checksum: "f1a6cba90fb5661ac580e81e871f5628cbb7c24559d22a6f40196ef671fe31c4"
		)
	]
)