...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.41.xcframework.zip",
			checksum: "c13aa256ecbbb96ed5e8f0ad0f4f12df47b6698bf26d4f801aba53d3707e6bcd"
		)
	]
)