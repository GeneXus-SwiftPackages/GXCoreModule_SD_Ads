...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.35.xcframework.zip",
			checksum: "9baced825258538191191bea8e95a80e4965a8abb060a20a10c9753d80eb670f"
		)
	]
)