...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.45.xcframework.zip",
			checksum: "3e86aafaed1c2ef972c7ae9fa7076482abca14350212cd8e25cdd725bd3fd685"
		)
	]
)