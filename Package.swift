...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.4.0-rc.21.xcframework.zip",
			checksum: "3971f6a0790c8b7f6fa422e0d816ea26657973585a16727e259db96ff8a90c90"
		)
	]
)