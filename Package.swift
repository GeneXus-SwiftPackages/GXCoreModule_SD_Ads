...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.36.xcframework.zip",
			checksum: "753a265283b3f73068c2923dc761f840c31ccd8e60fd64050951b180e4565ecf"
		)
	]
)