...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.0.3.xcframework.zip",
			checksum: "a46c8f877da71ed4273909cdd95ccfc5d77e1725b72712ac2b15a47e41e39729"
		)
	]
)