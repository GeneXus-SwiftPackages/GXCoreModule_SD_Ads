...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.1.0-rc.4.xcframework.zip",
			checksum: "897063be290e653ce6677dbc3f604fd5fdf53cfc38fb0e669bb4d437ffadc13b"
		)
	]
)