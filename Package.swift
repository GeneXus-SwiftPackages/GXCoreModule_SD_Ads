...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.6.0-rc.0.xcframework.zip",
			checksum: "9def1e7f7a05d34c9bf4a331d512a71d78f79dcbb1688293746591d2bbd673a4"
		)
	]
)