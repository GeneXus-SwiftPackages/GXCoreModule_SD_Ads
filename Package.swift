...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.17.xcframework.zip",
			checksum: "e285c86469c916fcfc9654063c49890b7b09a011bedbe10ecc14b742f9276fd1"
		)
	]
)