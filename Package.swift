...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.11.xcframework.zip",
			checksum: "9aab2e78e860875f497fc4c490117945b08044eee35109c259fc7c1917a206a8"
		)
	]
)