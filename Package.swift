...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.3.xcframework.zip",
			checksum: "d03cbad270357f69995b145c49688228d1ac560635d3b4db585d40ed42e3fa86"
		)
	]
)