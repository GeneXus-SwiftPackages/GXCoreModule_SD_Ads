...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.29.xcframework.zip",
			checksum: "1e6cf9626a7dc3dec8aa2def9b132e1e1ceb83df0176832664a69957d950e239"
		)
	]
)