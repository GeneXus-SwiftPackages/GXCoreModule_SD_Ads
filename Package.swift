...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.5.xcframework.zip",
			checksum: "0ad3ab64194919db4b4e0c3854438ae63b8ddbb582e00620f38b620fdc59e6e2"
		)
	]
)