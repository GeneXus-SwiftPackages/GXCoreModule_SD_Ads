...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.29.xcframework.zip",
			checksum: "ad0a0c8fc898cacdbc494e999b8ec62b44716e5df192076b20c3109dc53e22d5"
		)
	]
)