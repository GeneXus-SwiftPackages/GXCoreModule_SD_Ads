...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.10.xcframework.zip",
			checksum: "a3872df26459fccebb3fca783ac37484031260496b98412517a4cbfb5dd30832"
		)
	]
)