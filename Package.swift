...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.5.xcframework.zip",
			checksum: "1feb8cae9c279bbcc039208e3acb0ad7f525eff6f2f7af7851c0782bc6d0bfae"
		)
	]
)