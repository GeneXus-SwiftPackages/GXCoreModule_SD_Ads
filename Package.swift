...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.0.7.xcframework.zip",
			checksum: "560674b7b40058c94d4a95e7a0a4013aab73c1ef155b9dddc68463b4124a7f4c"
		)
	]
)