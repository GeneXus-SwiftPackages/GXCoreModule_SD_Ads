...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.7.xcframework.zip",
			checksum: "fbb04625a7112935da860a33a68444b2c59d18d6990cfa7677be42d0f4d9283d"
		)
	]
)