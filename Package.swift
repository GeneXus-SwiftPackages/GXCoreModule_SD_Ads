...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "cbb290b4d4097ec97ae54797a3ca710c3a0bffe512012ae761c23eed9ce890c5"
		)
	]
)