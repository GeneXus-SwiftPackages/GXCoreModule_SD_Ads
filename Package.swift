...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.1.0-rc.24.xcframework.zip",
			checksum: "4a056af0aa21cf50f225d45255494951745e805521176c4381f42e559bd122cd"
		)
	]
)