...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-2.1.4.xcframework.zip",
			checksum: "837aacd39f62e8113ac0479ba0389fc6b128a158140436be4c9ff7768098011e"
		)
	]
)