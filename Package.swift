...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.1.0.xcframework.zip",
			checksum: "2b089081da79c18a4b2772a6280cb191957e9e3d06e37ff55b0ac0f4dbb7ca1d"
		)
	]
)