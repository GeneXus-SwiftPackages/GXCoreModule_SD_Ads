...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "5e5ad148ee8c13fd031568233ed344049e95a2f5381ec64422b491ac64aa5d2f"
		)
	]
)