...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.25.xcframework.zip",
			checksum: "099b4c21a444d40be06c8628962c392e7afa1fe21900a009577f1a673dddfc04"
		)
	]
)