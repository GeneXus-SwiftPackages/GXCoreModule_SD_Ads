...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.20.xcframework.zip",
			checksum: "609ab6e02d66f1ec61e1c939b4e4cd6394264b298bfae8fef51ee8d98ee3f6df"
		)
	]
)