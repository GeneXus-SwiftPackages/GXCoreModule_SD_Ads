...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.12.xcframework.zip",
			checksum: "892204703f0a7f75ecf9e838de59fc2ba9c9c9eb6ac5ae6de8ece02534ef7a24"
		)
	]
)