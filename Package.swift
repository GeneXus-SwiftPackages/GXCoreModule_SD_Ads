...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.29.xcframework.zip",
			checksum: "2e07ac8d407e607044d07374e30b0a4224d6a34357dae5ad5e4794ea70bee9bb"
		)
	]
)