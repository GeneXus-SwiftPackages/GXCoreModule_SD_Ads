...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.0.xcframework.zip",
			checksum: "54444270e13753e6a2270eca1f01cbbbc07000088600ad6b6765526d9a2e5b70"
		)
	]
)