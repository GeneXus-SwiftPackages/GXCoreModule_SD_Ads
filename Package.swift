...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.16.xcframework.zip",
			checksum: "ff76e30c925392c511a2cd5a760acd23efd87cc013e79fd7606ceec9791c1241"
		)
	]
)