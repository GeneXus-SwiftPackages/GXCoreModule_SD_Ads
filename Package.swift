...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.25.xcframework.zip",
			checksum: "5445a7d2615c2ed1b6cf479ccc20a0ccabd9c9c06e5a3cb4e153c8e115a4999c"
		)
	]
)