...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "3ddc0c66c447b1539ec00fa3be789f1df38ead42f37a038c0973e1e26ad22601"
		)
	]
)