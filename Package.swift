...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-1.4.30.xcframework.zip",
			checksum: "0105eafa9c1c7afae2251c1ad8679de2fe873cc7dad57dd8222a9cf739dd8b24"
		)
	]
)