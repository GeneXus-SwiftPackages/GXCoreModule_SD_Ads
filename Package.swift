...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.4.0-beta.17.xcframework.zip",
			checksum: "5a20146ea1e2732399877bff10624a02672ee74106be98fe20918bb48fba6c5f"
		)
	]
)