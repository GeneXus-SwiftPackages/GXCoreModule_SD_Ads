...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.31.xcframework.zip",
			checksum: "c3adc8263f8694d395b8a614ac911e09b7a264385f1098af0d53590755f33c10"
		)
	]
)