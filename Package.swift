...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-4.1.0-rc.25.xcframework.zip",
			checksum: "f78df535de876663f0a1452ff327002173bc512c446ff4f718a05af11f2fe88d"
		)
	]
)