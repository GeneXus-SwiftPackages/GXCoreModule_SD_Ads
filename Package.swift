...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.2.0-rc.36.xcframework.zip",
			checksum: "e96ec66370c15761ac344d6fcd668885e60127fefb9c3bfb1677a2c7cd33923e"
		)
	]
)