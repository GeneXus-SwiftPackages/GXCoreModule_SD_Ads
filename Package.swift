...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.3.0-beta.9.xcframework.zip",
			checksum: "4cef8999009bff4cf53274fffc412e667abd27a264f3345d227f0bf720bab5b0"
		)
	]
)