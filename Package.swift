...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.0.0-beta.49.xcframework.zip",
			checksum: "c7bbc29d6213b3f9d2c1cab408193337add9ad7df175205cbf70a7a3b2a65949"
		)
	]
)