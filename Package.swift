...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.28.xcframework.zip",
			checksum: "e5b3da8f232c672611dfd4a74c62f6ca1514420a8b001e0473ca86ca375868d0"
		)
	]
)