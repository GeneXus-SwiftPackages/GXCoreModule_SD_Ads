...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.38.xcframework.zip",
			checksum: "72cc14617bdcb2f2b5d0578e3f05768b05db9f1efe7771f6e400063148410a7a"
		)
	]
)