...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.1.0-rc.3.xcframework.zip",
			checksum: "1823c691632a2524b605909a500f150b8bbc98a3f2a530dc3f9759628993b38b"
		)
	]
)