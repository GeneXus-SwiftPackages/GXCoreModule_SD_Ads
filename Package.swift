...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-2.0.12.xcframework.zip",
			checksum: "77e79b163106e32ce517f5ff37fd5da4c640d9ad658bef2ec5f69f4de675a35a"
		)
	]
)