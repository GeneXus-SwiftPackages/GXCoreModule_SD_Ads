...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.13.xcframework.zip",
			checksum: "65669b1d7814a5303abe057a582193baccfe525353b042f3435c9db58f4b34c4"
		)
	]
)