...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.1.5.xcframework.zip",
			checksum: "263866b539910310d09fd9cf5c084c1f9c3397e8718e22334793a03b28eb2def"
		)
	]
)