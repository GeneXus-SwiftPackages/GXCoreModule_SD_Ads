...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.0.0-beta.23.xcframework.zip",
			checksum: "97c5ce3a966143c94843b8d5633ba72147fa23d93b19de23f310842a147c23f2"
		)
	]
)