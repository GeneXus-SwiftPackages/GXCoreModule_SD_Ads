...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.2.0.xcframework.zip",
			checksum: "becd79b7d799b4052a7bdcb0bd51a75add71d696e198aa5fef290bfa89914615"
		)
	]
)