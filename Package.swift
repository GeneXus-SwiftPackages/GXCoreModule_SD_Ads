...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.8.xcframework.zip",
			checksum: "d9678e1253cd44cecaf2c35ad012524bc2dace442f74a965095c643c9962ef3b"
		)
	]
)