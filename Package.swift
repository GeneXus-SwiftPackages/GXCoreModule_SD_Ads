...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.17.xcframework.zip",
			checksum: "60d008a60897a7a7a823925ddfbd8a60f94a5f092c48d1b6a1c99f875d8e01c5"
		)
	]
)