...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.5.0-rc.28.xcframework.zip",
			checksum: "a8c4259f328bb08b025e2d17651661f2bb9c478b79cc23c09def93d7c998f979"
		)
	]
)