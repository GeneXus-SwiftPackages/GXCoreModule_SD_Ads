...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-2.0.18.xcframework.zip",
			checksum: "42cdb873ca889d54e6aa41ce26c0aa34193f96e99f3bde60ba9bafdfe6c181b6"
		)
	]
)