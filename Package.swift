...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.6.xcframework.zip",
			checksum: "8b68aa7dfa7720378f03411ba64502b8af5a6efd75e2c07dc25768cf0896ae46"
		)
	]
)