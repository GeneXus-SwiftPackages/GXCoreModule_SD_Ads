...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.13.xcframework.zip",
			checksum: "619e53ba1fa66bb76e197cbb40bcffbd1b5ee011655cc3842d78d06987b85e36"
		)
	]
)