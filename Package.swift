...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.8.xcframework.zip",
			checksum: "83f5d79326c9f05ff7264e7c8252e87516e10e7597307f4b9e3d0a79521c4f1d"
		)
	]
)