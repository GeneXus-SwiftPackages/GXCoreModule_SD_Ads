...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.19.xcframework.zip",
			checksum: "fe2d17da4ca98937cb7a40733d95a2c54f6d0305bb6c4f81f6f25f08ce59042a"
		)
	]
)