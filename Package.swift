...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-2.1.0-rc.25.xcframework.zip",
			checksum: "b4d056abecfeb8ec7ceea806e18098d877819a79684fb08c06ad889ed660ecd8"
		)
	]
)