...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.22.xcframework.zip",
			checksum: "046f1afebd9e3eb398b87bdd038bb7d6c2e3ffdf97394bb8e2471feeef144cae"
		)
	]
)