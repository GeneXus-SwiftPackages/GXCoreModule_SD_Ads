...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.0.16.xcframework.zip",
			checksum: "9864509a2339c48e4d7d162fb594a176551442bb210e812c9912dc5da05d8246"
		)
	]
)