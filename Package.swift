...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-2.2.0-rc.3.xcframework.zip",
			checksum: "20fae32169080c8f6b441918fe1adc00a18ed2d2d39e5d4d551e44b99d623faa"
		)
	]
)