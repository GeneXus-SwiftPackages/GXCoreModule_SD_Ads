...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.1.0-beta.9.xcframework.zip",
			checksum: "ffde75ed08e5fd102d7a586ddeb01f1f992bc148fc61691fd5b23208044cb55d"
		)
	]
)