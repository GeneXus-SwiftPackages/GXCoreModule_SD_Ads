...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-5.0.0-rc.1.xcframework.zip",
			checksum: "34b13a8e4832bb19cfb3225383b1d86871a9acb3bb4bf619ab29dab404055da5"
		)
	]
)