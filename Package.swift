...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.6.0-beta.2.xcframework.zip",
			checksum: "d9a3abda0586378c8082ea94ed42a480d4cf9d715689680bd2e8b20e27aada7b"
		)
	]
)