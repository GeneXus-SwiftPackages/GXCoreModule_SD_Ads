...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.1.0-beta.13.xcframework.zip",
			checksum: "725e1a056e2c9305d4989eb0da74137e815d2dc4df2c7159cefcfd61b9bb6ded"
		)
	]
)