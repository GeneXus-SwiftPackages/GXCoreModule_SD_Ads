...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.39.xcframework.zip",
			checksum: "58f9a69c889548d696620eb9b1e98af3d890912d4c17d2a32a0137e3a2bf789d"
		)
	]
)