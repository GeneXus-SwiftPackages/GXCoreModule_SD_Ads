...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.20.xcframework.zip",
			checksum: "844118e21025ffaf64dabd607577997315ab07766b26e4149be6ac128926bd19"
		)
	]
)