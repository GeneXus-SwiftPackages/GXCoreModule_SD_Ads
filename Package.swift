...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.38.xcframework.zip",
			checksum: "fd91c190f7bf9b0782f1256a7055c0aeb7cddba3ba9098a22ccc43f20a08615c"
		)
	]
)