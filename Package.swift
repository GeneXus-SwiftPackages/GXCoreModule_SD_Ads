...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-4.1.3.xcframework.zip",
			checksum: "b7576f47a33477f92652d4ba0e22a1250591d90328f3b576e5b7ce829d4d67a3"
		)
	]
)