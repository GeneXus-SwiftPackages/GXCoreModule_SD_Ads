...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.2.0-beta.14.xcframework.zip",
			checksum: "164e0bbb186888c97e597a528f33258dcaa2e5ee6d6d2ed61a69d0fd33fb4ebe"
		)
	]
)