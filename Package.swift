...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Ads-3.0.1.xcframework.zip",
			checksum: "ff17c0717a19a16e6a2cdfb9cd46028d32171e8265a9ffec86bc3d943e8ef1ff"
		)
	]
)