...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.1.0-rc.5.xcframework.zip",
			checksum: "cf55e97486555690caef677c732a8093012ef67e842c5c8ef63ecd93be29dc11"
		)
	]
)