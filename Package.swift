...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.3.0-rc.13.xcframework.zip",
			checksum: "9cc7b80fa163d438a112cf64981de65a8f1a8561d044596bbd72786caa08ee45"
		)
	]
)