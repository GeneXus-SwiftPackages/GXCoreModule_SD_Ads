...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.7.xcframework.zip",
			checksum: "c7b6cf244ca6f095e6cc223a15f56a5b3d0dcbb592e28faa5523fbec5edcee69"
		)
	]
)