...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.21.xcframework.zip",
			checksum: "b573605c488d9495c8445db3257bc0dd9596637e4cf99f10f83ac6a86090952a"
		)
	]
)