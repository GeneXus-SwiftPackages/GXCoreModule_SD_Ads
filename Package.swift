...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-2.2.0-beta.21.xcframework.zip",
			checksum: "a029566468fa4ec29198be8ffa1f610ec6cf6c31af28bbd884fdc7b5cca6bbff"
		)
	]
)