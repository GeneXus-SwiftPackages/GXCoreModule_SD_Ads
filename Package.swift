...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.2.0-beta.40.xcframework.zip",
			checksum: "95e6839173cc36d5c6b41e6d1a8a230eb62253c9d5b26a9744462505434cc962"
		)
	]
)