...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.5.0-beta.16.xcframework.zip",
			checksum: "5a29491d85ea9c93c3392a6af5f8ac5b954537a559c492071d2c7cab1ec739fd"
		)
	]
)