...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-3.0.0-beta.16.xcframework.zip",
			checksum: "1039c49a980fc31ba5afe456fd3df899331f14a30039a40927ac452d605dd787"
		)
	]
)