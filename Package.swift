...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-1.2.0-beta.14.xcframework.zip",
			checksum: "98f0cb5f5624b41c108b9c3cef997243b9b928652a16a1783419ceb8bd8daf3c"
		)
	]
)