...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Ads-1.2.0-rc.15.xcframework.zip",
			checksum: "e71f62eb07439b58d5baf54143d9dff56a96c2df76939248ab707fd5fc8024ca"
		)
	]
)