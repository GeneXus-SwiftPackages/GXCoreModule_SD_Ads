...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Ads",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Ads-4.1.0-beta.2.xcframework.zip",
			checksum: "55c83ea630a52abcd6a510d25dd7c5baba6413847b7c1e52fee5ee264ccc9648"
		)
	]
)